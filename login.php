    ...
    <section id="loginSection">
        ...
        <form id="loginForm" name="loginForm">
            <fieldset id="loginInputs">
                ...
                <input type="text" id="ppcUsername" class="loginInput" name="ppcUsername" minlength="3" maxlength="32" size="10" required title="Usernames cannot be empty and have to be composed out of minimum 3 lower or upper case characters or numbers. Please try again." />
